...
export const ROLE_PATHS={
  ...
  'Maintenance Manager':['/dashboard','/departments','/categories','/assets','/resources','/bookings','/maintenance','/notifications','/profile'], Auditor:['/dashboard','/departments','/categories','/assets','/resources','/bookings','/audits','/notifications','/profile'],
